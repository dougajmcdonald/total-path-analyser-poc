// DEPRECATED: Game state management for Lorcana simulation
// Use entities/game/IGameState.js and utils/GameStateFactory.js instead
...
export function drawCard(gameState, playerId) {
  ...
  // Log the card draw
  console.log(
    `  📥 ${playerId} drew: ${drawnCard.name} (Cost: ${drawnCard.cost}, Inkable: ${drawnCard.inkable})`
  )
